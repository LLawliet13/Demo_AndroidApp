...
import com.example.myapplication.adapter.AddressListAdapter;
import com.example.myapplication.bean.AddressInfo;
...
public class AddressListActivity extends AppCompatActivity {
    ...
    private void sendNotification(){
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel(CHANNEL_ID, "DEMO notification app", NotificationManager.IMPORTANCE_HIGH);
    ...
    public void requestLocationPermission(){
        if(checkSelfPermission(Manifest.permission.ACCESS_FINE_LOCATION)!= PackageManager.PERMISSION_GRANTED){
            if(shouldShowRequestPermissionRationale(Manifest.permission.ACCESS_FINE_LOCATION)){
                ...
                builder.setMessage("please grant locaiton service permission");
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
    ...
    public void onRequestPermissionsResult(int requestCode,String[] permissions,int [] grantResults){
        ...
        switch (requestCode){
            ...
            &&grantResults[0]==PackageManager.PERMISSION_GRANTED){
                Toast.makeText(this,"Location perssion granted by user",Toast.LENGTH_LONG).show();
            }else{
                Toast.makeText(this,"Location perssion is not granted by user",Toast.LENGTH_LONG).show();
            }
            break;
        }
    }
